<html>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      ...
      <a class="btn btn-success" href="./view/login.php"><b>Fazer login</b></a>
    </a>
  </div>
</nav>
    <h3>SOBRE</h3>
    <div class="text-center">
      <p align="justify">Um pet shop é um estabelecimento comercial que oferece uma variedade de produtos e serviços para animais de estimação, como cães, gatos, pássaros, roedores e répteis.  </p>
